...
function applyFilters(){
  ...
  const result=$('shipmentFilterResult');if(result){const parts=[];if(type!=='cement')parts.push(`<span class="sqf-badge">🚚 ${cc} beton · ${trNum(m3)} m³</span>`);if(type!=='concrete')parts.push(`<span class="sqf-badge sqf-badge-cement">🏗️ ${zc} çimento · ${vehicles} araç · ${pallets} palet · ${trNum(tons)} ton</span>`);result.innerHTML=parts.join('')}
