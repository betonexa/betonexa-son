...
(function loadRecordsCementAddon(){if(document.querySelector('script[src^="./records-cement-addon.js"]'))return;const s=document.createElement("script");s.src="./records-cement-addon.js?v=20260925-notes1";s.defer=true;document.head.appendChild(s)})();
(function loadCementPalletExports(){if(document.querySelector('script[src^="./cement-pallet-exports.js"]'))return;const s=document.createElement("script");s.src="./cement-pallet-exports.js?v=20260925-notes1";s.defer=true;document.head.appendChild(s)})();
